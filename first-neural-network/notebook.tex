...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:}    instant      dteday  season  yr  mnth  hr  holiday  weekday  workingday  \textbackslash{}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} <matplotlib.axes.\_subplots.AxesSubplot at 0x10d0fa7b8>
\end{Verbatim}
...
{\ldots}E
======================================================================
ERROR: test\_train (\_\_main\_\_.TestMethods)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "<ipython-input-11-add1f7c23be2>", line 40, in test\_train
    network.train(inputs, targets)
  File "/Users/Dad/deep-learning/first-neural-network/my\_answers.py", line 54, in train
    self.update\_weights(delta\_weights\_i\_h, delta\_weights\_h\_o, n\_records)
  File "/Users/Dad/deep-learning/first-neural-network/my\_answers.py", line 111, in update\_weights
    self.weights\_hidden\_to\_output += None \# update hidden-to-output weights with gradient descent step
TypeError: ufunc 'add' output (typecode 'O') could not be coerced to provided output parameter (typecode 'd') according to the casting rule ''same\_kind''
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/Users/Dad/anaconda3/lib/python3.6/site-packages/ipykernel/\_\_main\_\_.py:17: DeprecationWarning: 
...
http://pandas.pydata.org/pandas-docs/stable/indexing.html\#ix-indexer-is-deprecated
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-12-fe184d1fa5e2> in <module>()
         17     X, y = train\_features.ix[batch].values, train\_targets.ix[batch]['cnt']
         18 
    ---> 19     network.train(X, y)
         20 
         21     \# Printing out the training progress


        \textasciitilde{}/deep-learning/first-neural-network/my\_answers.py in train(self, features, targets)
         52             delta\_weights\_i\_h, delta\_weights\_h\_o = self.backpropagation(final\_outputs, hidden\_outputs, X, y, 
         53                                                                         delta\_weights\_i\_h, delta\_weights\_h\_o)
    ---> 54         self.update\_weights(delta\_weights\_i\_h, delta\_weights\_h\_o, n\_records)
         55 
         56 


        \textasciitilde{}/deep-learning/first-neural-network/my\_answers.py in update\_weights(self, delta\_weights\_i\_h, delta\_weights\_h\_o, n\_records)
        109 
        110         '''
    --> 111         self.weights\_hidden\_to\_output += None \# update hidden-to-output weights with gradient descent step
        112         self.weights\_input\_to\_hidden += None \# update input-to-hidden weights with gradient descent step
        113 
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/Users/Dad/anaconda3/lib/python3.6/site-packages/ipykernel/\_\_main\_\_.py:10: DeprecationWarning: 
.ix is deprecated. Please use
.loc for label based indexing or
.iloc for positional indexing
