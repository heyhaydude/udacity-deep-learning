...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = np.dot(output_error_term, self.weights_hidden_to_output.T)   # errors propagated to the hidden layer
        hidden_error_term = hidden_error * (hidden_outputs * (1.0 - hidden_outputs)) # uses derivative of sigmoid in the hidden 
